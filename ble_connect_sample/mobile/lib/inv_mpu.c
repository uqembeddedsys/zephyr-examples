...
#define i2c_write(a, b, c, d) zephyr_i2c_write_wrapper(a, b, c, d)
#define i2c_read(a, b, c, d) zephyr_i2c_read_wrapper(a, b, c, d)
#define delay_ms zephyr_delay_wrapper
#define get_ms zephyr_get_ms
#define log_i printk
#define log_e printk
